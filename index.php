...
$rt->get("/invoice/history", OrdersPendingController::class);
$rt->get("/invoice/*", OrdersPendingController::class, ['one']);
$rt->get("/credit/history", OrderHistoryController::class);
$rt->get("/credit/*", OrderHistoryController::class, ['one']);
